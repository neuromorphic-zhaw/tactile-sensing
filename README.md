# tactile-sensing
An ultra-low-power, event-based tactile sensor integrating a markerless GelSight with the SynSense Speck neuromorphic chip for high-speed force, texture and curvature detection.
